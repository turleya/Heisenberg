...
for i in range(200, 1500, 50):
    ...
    callback_list = [EarlyStopping(monitor='val_loss', min_delta=1e-7, patience=10, verbose=1), ModelCheckpoint(filepath='s_lattice.h5', monitor='val_loss', verbose=1, save_best_only=True)] #creates a HDF5 file 'my_model.h5'
    n_epochs = 100
    ...
    #Predictions
    model_best = load_model('s_lattice.h5')
